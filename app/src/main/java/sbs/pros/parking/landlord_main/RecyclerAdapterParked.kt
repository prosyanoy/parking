...
class RecyclerAdapterParked(var parkedParkers: ArrayList<Parker>) : RecyclerView.Adapter<RecyclerAdapterParked.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerAdapterParked.ViewHolder{
    ...
    override fun onBindViewHolder(holder: RecyclerAdapterParked.ViewHolder, position: Int){
